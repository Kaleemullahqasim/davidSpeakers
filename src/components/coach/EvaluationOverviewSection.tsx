...
export function EvaluationOverviewSection({
  ...
  const maxTotalPoints = evaluation?.results?.skill_scores?.reduce((total: number, skill: any) => 
  ...
  const handleDividerChange = (newDivider: number) => {
    ...
    const totalPoints = evaluation?.results?.skill_scores?.reduce((total: number, skill: any) => {
